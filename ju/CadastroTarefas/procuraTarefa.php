<?php
    ...
    $pesquisa = '%' . $descricao . '%';
    $PDO = db_connect();
    $sql = "SELECT Ta.id, Ta.descricaoTarefa, Ta.status, Ti.descricaoTipo FROM tarefas as Ta inner join tipos as Ti on Ta.tipo_id = Ti.id WHERE upper(Ta.descricaoTarefa) like :descricao";
