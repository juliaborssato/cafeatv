<?php
    ...
    $pesquisa = '%' . $quantidade . '%';
    $PDO = db_connect();
    $sql = "SELECT Ta.id, Ta.descricaoTarefa, Ti.QtdCafe FROM quantidade as Ta inner join tipos as Ti on Ta.tipo_id = Ti.id WHERE upper(Ta.descricaoTarefa) like :descricao";
